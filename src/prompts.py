...
LOCAL_CHUNK_PROMPT_RU = """\
Выбери самые информативные отрывки для саммари из пронумерованного списка.
Приоритет: цели, выводы, решения, задачи, сроки, ограничения и определения.
Покрой разные темы. Предпочитай ясные формулировки вместо повторов, оговорок,
шумов распознавания и длинных условных примеров. Сохраняй отрывки с уточнениями
и условиями, без которых вывод меняет смысл. Не пересказывай текст.
Ответ: JSON {"keep": [номера отрывков]}; количество ограничено схемой.
