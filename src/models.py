...
class Block:
    ...
    before it on save — an accepted simplification of the editable-Markdown model).
    """
...
class MeetingSummary:
    ...
    parsing the canonical Markdown (``formatters.parse_summary``); rendered to Markdown / plain /
